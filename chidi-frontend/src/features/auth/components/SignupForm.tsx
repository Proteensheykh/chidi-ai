    ...
    return (
      <div className="space-y-6">
        ...
        <Button
          ...
          variant="outline"
          className="w-full rounded-full py-5 border border-gray-300 text-base font-medium"
        >
    ...
    <div className="w-full">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Input
              ...
              disabled={loading}
              className={`rounded-md border border-gray-300 px-4 py-3 text-base ${validationErrors.confirmPassword ? 'border-red-500' : ''}`}
            />
        ...
        <div className="text-center mt-2 text-xs text-gray-500">
          <p>
            By clicking "Sign up with Google" or "Sign up with Apple" you agree to our <Link href="/terms" className="text-blue-600">Terms of Use</Link> and acknowledge that you have read and understand our <Link href="/privacy" className="text-blue-600">Privacy Policy</Link>.
          </p>
        </div>
      </form>
    </div>
